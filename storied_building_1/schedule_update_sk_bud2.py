...
# test_tmp121    query2 = "select count(*) from test_big_af"
...
#     print(max[0])
    ...
    while not(data is None):
        ...
        for item in data:
            ...
            query4 = " select * from test_bud127 where "
            flag1 = 0
            whers = ""
            ...
            if flag1 == 1:
                ...
                if len(data41) > 0 and not(data4 is None):
                    ...
                    if item4[0].strip() != 'None':
                        query5 = query5 + "CsmBuildingID3 = %s " % (item4[0])
                        fis1 = 1
                    if item4[1].strip() != 'None':
                        if fis1 == 1:
                            ...
                            fis1 = 1
                        query5 = query5 + "pm_Building_ID3 = %s " % (item4[1])
                    if item4[2].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "Buildingcode3 = %s " % (item4[2])
                    if item4[3].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "Building_ID3 = %s " % (item4[3])
                    if item4[4] .strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "regionsnum3 = %s " % (item4[4])
                    if item4[5].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "regioncode3 = %s" % (item4[5])
                    if item4[6].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "project_ID3 = %s" % (item4[6])
                    if item4[7].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "project_name3 = %s" % (item4[7])
                    if item4[8].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "is_public3 = %s" % (item4[8])
                    if item4[9].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "vitual3 = %s" % (item4[9])
                    ...
                    if item4[10].strip() != 'None':
                        if fis1 == 1:
                            ...
                            fis1 = 1
                        query5 = query5 + "unitsnum3 = %s" % (item4[10])
                    if item4[11].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "floorsnum3 = %s" % (item4[11])
                    if item4[12].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "is_del3 = %s" % (item4[12])
                    if item4[13].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "plan_id3 = %s" % (item4[13])
                    if item4[14].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "plan_name3 = %s" % (item4[14])
                    if item4[15].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "commid3 = %s" % (item4[15])
                    if item4[16].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "regionname3 = %s" % (item4[16])
                    if item4[17].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "building_type3 = %s" % (item4[17])
                    if item4[18].strip() != 'None':
                        if fis1 == 1:
                            query5 = query5 + ", "
                        else:
                            fis1 = 1
                        query5 = query5 + "budname3 = %s" % (item4[18])
