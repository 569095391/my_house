...
-- ----------------------------
-- Table structure for test_tmp128
-- ----------------------------
DROP TABLE IF EXISTS `test_tmp128`;
CREATE TABLE `test_tmp128`  (
  ...
  `is_del` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
