...
-- ----------------------------
-- Table structure for test_tmp127
-- ----------------------------
DROP TABLE IF EXISTS `test_tmp127`;
CREATE TABLE `test_tmp127`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 32768 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
